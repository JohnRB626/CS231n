...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for l, (i, j) in enumerate(zip([input_dim, *hidden_dims], [*hidden_dims, num_classes])):
            self.params[f'W{l+1}'] = np.random.normal(0.0, weight_scale, (i, j))
    ...
    def loss(self, X, y=None):
        ...
        for l in range(self.num_layers):
            ...
            bn_param = self.bn_params[l] if gamma is not None else None
            bn_cache = None
            ...
            cache[l] = [affine_cache, relu_cache, bn_cache, do_cache]
        ...
        for l in reversed(range(self.num_layers)):
            fc_cache, relu_cache, bn_cache, do_cache = cache[l]
